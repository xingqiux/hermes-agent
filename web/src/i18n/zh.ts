...
export const zh: Translations = {
  ...
  status: {
    ...
    updateAvailable: "GitHub 汉化版有新版本",
    noUpdateAvailable: "已是最新：GitHub 汉化版没有新版本",
    updateCheckFailed: "检查更新失败",
    localizedUpdateHint: "检查 GitHub 汉化版是否有新版本；部署请在 Dashboard 外执行。",
  ...
  models: {
    page: {
      ...
      unset: "未设置",
      analyticsHiddenBefore: "Token 与费用统计默认隐藏，因为本地计数不包含辅助调用和 provider 重试。可在配置中启用",
      analyticsHiddenAfter: "以显示本地调试估算值。",
      switchModel: "切换模型",
      currentModel: "当前模型",
      unknown: "未知",
      filterModels: "筛选提供方和模型...",
      savesGlobally: "保存到 config.yaml，并应用于新会话。",
      persistGlobally: "全局保存（否则仅当前会话生效）",
      refreshModels: "刷新模型",
      cancel: "取消",
      switch: "切换",
  ...
  oauth: {
    ...
    disconnect: "断开连接",
    disconnectConfirm:
      "这会移除 {provider} 已保存的 OAuth 令牌。之后需要重新认证才能继续使用。",
