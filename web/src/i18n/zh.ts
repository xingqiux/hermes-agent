...
export const zh: Translations = {
  ...
  models: {
    page: {
      ...
      analyticsHiddenAfterConfig: "以显示本地调试估算值。",
      analyticsHiddenBeforeConfig: "Token 与费用统计已隐藏，因为本地计数不包含辅助调用和提供商重试。请在",
      analyticsHiddenConfig: "配置中启用",
      appliesToNewSessions: "应用于新会话",
      automatic: "自动",
      auxiliaryTasks: "辅助任务",
      auxiliaryTasksDescription: "辅助任务用于处理视觉、会话搜索和压缩等后台工作。“自动”表示使用主模型；也可为每项任务指定更便宜或更快的模型。",
      autoUseMainModel: "自动（使用主模型）",
      cacheRead: "缓存读取",
      cancel: "取消",
      change: "更换",
      configure: "配置",
      configureMoaPresets: "配置多模型协作预设",
      current: "当前",
      currentModel: "当前模型：",
      defaultLabel: "默认",
      deletePreset: "删除预设",
      expensiveModelWarning: "高费用模型提醒",
      filterModels: "筛选提供商和模型…",
      input: "输入",
      mainModel: "主模型",
      mixtureOfAgents: "多模型协作",
      moaDescription: "预设会显示为“多模型协作”提供商下的模型。参考模型生成不同视角，聚合模型负责最终回答和调用工具。",
      ...
      providerPlaceholder: "（提供商）",
      reasoning: "推理",
      recursiveMoaError: "多模型协作预设不能引用或聚合多模型协作提供商（不支持递归）。",
      ...
      resetAuxiliaryDescription: "确定将所有辅助任务重置为“自动”吗？这会覆盖你设置的每项任务模型。",
      ...
      switchAnyway: "仍然切换",
      switchModel: "切换模型",
      tasksAllAutomatic: "项任务，全部自动",
      tools: "工具",
      unknown: "（未知）",
      unusuallyHighPricing: "此模型的已知价格异常高。",
      unset: "未设置",
      useAs: "用作",
      vision: "视觉",
    },
  ...
  oauth: {
    ...
    login: "登录",
    disconnect: "断开连接",
    disconnectConfirm: "这会移除 {provider} 已保存的 OAuth 令牌。之后需要重新认证才能继续使用。",
