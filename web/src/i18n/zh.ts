...
export const zh: Translations = {
  ...
  status: {
    ...
    stopped: "已停止",
    updateHermes: "更新汉化版",
    updatingHermes: "正在更新汉化版…",
    checkUpdates: "检查更新",
    checkingUpdates: "检查更新中…",
    updateAvailable: "官方有 {count} 个新提交",
    noUpdateAvailable: "已是最新：upstream/main 没有新提交",
    updateCheckFailed: "检查更新失败",
    localizedUpdateHint: "检查官方 upstream/main，更新时会保留本地汉化提交。",
    updateBlocked: "无法更新：{reason}",
    updateBlockedDirty: "当前工作区有未提交改动，无法更新。",
    updateBlockedDirtyWithCount:
      "官方有 {count} 个新提交，但当前工作区有未提交改动，无法更新。",
