...
export const en: Translations = {
  ...
  status: {
    ...
    updateAvailable: "GitHub fork has {count} newer build",
    noUpdateAvailable: "Already up to date with the GitHub fork",
    updateCheckFailed: "Update check failed",
    localizedUpdateHint: "Checks the GitHub fork for a newer build; deployment is handled outside the dashboard.",
  ...
  models: {
    page: {
      ...
      overrides: "overrides",
      automatic: "automatic",
      tasksAllAutomatic: "tasks, all automatic",
      ...
      unset: "Not set",
      analyticsHiddenBefore: "Token and cost analytics are hidden because local counts exclude auxiliary calls and provider retries. Enable",
      analyticsHiddenAfter: "in Config to show the local debug estimate.",
      switchModel: "Switch model",
      currentModel: "Current",
      unknown: "Unknown",
      filterModels: "Filter providers and models...",
      savesGlobally: "Saves to config.yaml and applies to new sessions.",
      persistGlobally: "Save globally (otherwise only for this session)",
