...
export const zhHant: Translations = {
  ...
  models: {
    page: {
      ...
      analyticsHiddenAfterConfig: "以顯示本機除錯估算值。",
      analyticsHiddenBeforeConfig: "Token 與費用統計已隱藏，因為本機計數不包含輔助呼叫和提供者重試。請在",
      analyticsHiddenConfig: "設定中啟用",
      appliesToNewSessions: "套用於新工作階段",
      automatic: "自動",
      auxiliaryTasks: "輔助任務",
      auxiliaryTasksDescription: "輔助任務用於處理視覺、工作階段搜尋和壓縮等背景工作。「自動」表示使用主模型；也可為個別任務指定更便宜或更快的模型。",
      autoUseMainModel: "自動（使用主模型）",
      cacheRead: "快取讀取",
      cancel: "取消",
      change: "變更",
      configure: "設定",
      configureMoaPresets: "設定多模型協作預設",
      current: "目前",
      currentModel: "目前模型：",
      defaultLabel: "預設",
      deletePreset: "刪除預設",
      expensiveModelWarning: "高費用模型提醒",
      filterModels: "篩選提供者和模型…",
      input: "輸入",
      mainModel: "主模型",
      mixtureOfAgents: "多模型協作",
      moaDescription: "預設會顯示為「多模型協作」提供者下的模型。參考模型產生不同觀點，彙總模型負責最終回答和呼叫工具。",
      modelCount: "{count} 個模型",
      modelPlaceholder: "（模型）",
      modelSettings: "模型設定",
      newPresetName: "新預設名稱",
      noAuthenticatedProviders: "沒有已驗證的提供者",
      noMatches: "沒有相符項目",
      noModelsListed: "此提供者沒有可用模型",
      noModelsMatch: "沒有符合篩選條件的模型",
      notLoaded: "尚未載入",
      output: "輸出",
      overrides: "項覆寫",
      pickProvider: "選擇提供者 →",
      providerDefault: "（提供者預設）",
      providerPlaceholder: "（提供者）",
      reasoning: "推理",
      recursiveMoaError: "多模型協作預設不能引用或彙總多模型協作提供者（不支援遞迴）。",
      referenceModels: "參考模型",
      references: "個參考模型",
      refreshModels: "重新整理模型",
      remove: "移除",
      resetAll: "全部重設",
      resetAllToAuto: "全部重設為自動",
      resetAuxiliaryDescription: "確定要將所有輔助任務重設為「自動」嗎？這會覆寫你設定的個別任務模型。",
      resetAuxiliaryModels: "重設輔助模型",
      save: "儲存",
      savesGlobally: "儲存至 config.yaml，並套用於新工作階段。",
      saving: "正在儲存…",
      selectMoaModel: "選擇 MoA 模型",
      setAuxiliary: "設定輔助任務：{task}",
      setDefault: "設為預設",
      switch: "切換",
      switchAnyway: "仍要切換",
      switchModel: "切換模型",
      tasksAllAutomatic: "項任務，全部自動",
      tools: "工具",
      unknown: "（未知）",
      unusuallyHighPricing: "此模型的已知價格異常高。",
      unset: "未設定",
      useAs: "用作",
      vision: "視覺",
    },
  ...
  oauth: {
    ...
    login: "登入",
    disconnect: "中斷連線",
    disconnectConfirm: "這會移除 {provider} 已儲存的 OAuth 權杖。之後需要重新驗證才能繼續使用。",
