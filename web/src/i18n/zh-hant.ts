...
export const zhHant: Translations = {
  ...
  status: {
    ...
    stopped: "已停止",
    updateHermes: "更新漢化版",
    updatingHermes: "正在更新漢化版…",
    checkUpdates: "檢查更新",
    checkingUpdates: "檢查更新中…",
    updateAvailable: "官方有 {count} 個新提交",
    noUpdateAvailable: "已是最新：upstream/main 沒有新提交",
    updateCheckFailed: "檢查更新失敗",
    localizedUpdateHint: "檢查官方 upstream/main，更新時會保留本地漢化提交。",
    updateBlocked: "無法更新：{reason}",
    updateBlockedDirty: "目前工作區有未提交變更，無法更新。",
    updateBlockedDirtyWithCount:
      "官方有 {count} 個新提交，但目前工作區有未提交變更，無法更新。",
  ...
  oauth: {
    ...
    disconnect: "中斷連線",
    disconnectConfirm:
      "這會移除 {provider} 已儲存的 OAuth 權杖。之後需要重新認證才能繼續使用。",
